...
export class RepositoryServices {
    ...
    public static Repository<T, TKey>(name: string): IRepository<T, TKey> {
        return RepositoryServices.Instance(name) as IRepository<T, TKey>;
    }
    public static Command<T, TKey>(name: string): ICommand<T, TKey> {
        return RepositoryServices.Instance(name) as ICommand<T, TKey>;
    }
    public static Query<T, TKey>(name: string): IQuery<T, TKey> {
        return RepositoryServices.Instance(name) as IQuery<T, TKey>;
    }
    private static Instance<T, TKey>(name: string): IRepository<T, TKey> | ICommand<T, TKey> | IQuery<T, TKey> {
